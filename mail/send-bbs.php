...
$subject = "Satyug - Best boarding school in Delhi NCR";

$message = "
<html>
<head>
<title>Leads SATYUG</title>
</head>
<body>
...
if ($ok){
 ...
 //die();
   ...
   //echo '1';
   //exit;
  header("Location: http://www.schools18.com/satyug-darshan-vidyalaya/thank-you.html");
  die();
}else{
   
    echo "Your form is not submitted Call 9654150000 Now";
}
